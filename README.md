...
Sidebar (left):
 ...
 2.onfigure Chunk size and Chunk overlap (or keep defaults).
...
Main panel:
 1.After indexing, type your question in the chat input.
 2.Expand “Sources” below an answer to see citations.

-------------------------------------------------------------------------------------------------------------------------------------------------------------

Special Cases
 1.Grounded answers only: The assistant answers strictly from retrieved chunks. If the info is not in the indexed documents, it will say it doesn’t know and suggest uploading more relevant files.
 2.Re-index semantics:
...
Have fun with the features provided!